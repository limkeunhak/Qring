<template>
  <div>
    ...
    <div class="home-holder">
      ...
      <!-- home:logo START -->
      <div class="logo">
        <img width="300" height="200" class="logo-txt" src="../assets/logo.png" alt="MH - Web Designer & Developer - Logo" />
        <div class="logo-bg-holder">
          <img width="460" height="500" style="margin-left:100px; margin-top:-290px;" src="../assets/logo-qany.png"/>
        </div>
      </div>
      <!-- home:logo END -->
